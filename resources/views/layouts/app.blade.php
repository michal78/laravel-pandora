            ...
            <nav class="pd-nav" aria-label="Main">
                @php
                    ...
                    $nav = collect([
                        ...
                        ['route' => 'pandora.channels',  'label' => 'Channels',  'glyph' => '◔', 'ability' => 'channels.view',
                         'soon' => \Pandora\UI\Feature::disabled('channels')],
                        ['route' => 'pandora.extensions', 'label' => 'Extensions', 'glyph' => '▥', 'ability' => 'extensions.view',
                         'soon' => \Pandora\UI\Feature::disabled('extensions')],
